...
PYBIND11_MODULE(surfe, m) {
    ...
    py::class_<Point>(m, "Point")
        ...
        .def("scalar_field",(double (Point::*)() const) &Point::scalar_field,"get scalar field value of point")
        .def("set_scalar_field", &Point::set_scalar_field)
        .def("scalar_field",(double  (Point::*)(const int &) const) &Point::scalar_field,"get scalar field using index")
