...
PYBIND11_MODULE(surfe, m) {
	...
	py::class_<model_parameters>(m, "model_parameters")
	    ...
	    .def_readwrite("use_planar_data",
			   &model_parameters::use_planar_data)
	    ...
	    .def_readwrite("shape_parameter",
			   &model_parameters::shape_parameter)
	    .def_readwrite("polynomial_order",
			   &model_parameters::polynomial_order)
	    .def_readwrite("shape_parameter",
			   &model_parameters::shape_parameter)
